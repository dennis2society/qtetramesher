...
void QuartetTetraStuffing::GenerateFromSurface(
    const std::vector<inTriangle> &tris, const std::vector<tmpVec3f> &verts,
    float gridSpacing, float angleThreshold, bool optimize) {
