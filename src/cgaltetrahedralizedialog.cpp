...
CGALTetrahedralizeDialog::CGALTetrahedralizeDialog(QWidget *parent) :
    ...
    m_ui(new Ui::CGALTetrahedralizeDialog)
{
    m_ui->setupUi(this);
    _viewer = NULL;
}
...
CGALTetrahedralizeDialog::~CGALTetrahedralizeDialog()
{
    delete m_ui;
}

void CGALTetrahedralizeDialog::setParams(const float tetraSize_, const float faceSize_)
{
