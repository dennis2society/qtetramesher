...
public:
   ...
   * Additionally we will set all necessary parameters for CGAL's meshing
   * algorithm.
   */
  void GenerateFromSurface(const std::vector<Triangle> &tris,
                           ...
                           const double facet_size_,
                           const double face_distance_,
                           const double cell_radius_dege_ratio_);
